...
public class StepSizeSettings {
   public static void initStepSizeSetting(DocumentState documentState, BeatBuddyExtension extension) {
      ...
      Setting noteLengthSetting = (Setting) documentState.getEnumSetting("Note Length", "Clip", Utils.STEPSIZE_OPTIONS, "1/16");
