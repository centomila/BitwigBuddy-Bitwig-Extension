...
| **Insert Drum Pad**                          | Inserts a blank drum pad in the selected drum machine         |_Insert Drum Pad ("C#2","Clap","333300")            |
| **Insert Device In Drum Pad**                | Inserts a blank drum pad in the selected drum machine         |_Insert Device In Drum Pad ("C1", "V0 Kick")_       |
