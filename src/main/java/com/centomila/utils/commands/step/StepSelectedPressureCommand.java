...
/**
 * Command to set the pressure (aftertouch) of selected note steps.
 */
public class StepSelectedPressureCommand extends BaseCommand {
    ...
    public void execute(String[] params, BitwigBuddyExtension extension) {
        ...
        try {
            ...
            reportError("Invalid pressure value: " + params[0], extension);
        }
    }
}
